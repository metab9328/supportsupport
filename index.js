...
let initialMessage = `**أهلا و سهلا بك في انست هوست :purple_heart: ,**`;
...
function generateMessages(){
    ...
    for (let role of roles) messages.push(`**"${role}"** الرجاء الضغط على الرياكشن لتفعيلك`); //DONT CHANGE THIS
    return messages;
}
